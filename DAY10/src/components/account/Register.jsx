...
function Register() {
  ...
  const validateAllinput = (gender, experience, size, interest, location) => {
    ...
    if (gender === "" && experience === "" && size === "" && interest === "" && location === "") {
  ...
  const handleNext = () => {
    if (step === 1) {
      ...
      const isFilled = checkinput(register.firstname,register.lastname,register.dob)
      ...
      const isFinalPassword = finalPassword(register.password, register.confirmpassword);

      if (isEmailValid && isPasswordValid && isFinalPassword) {
        setStep(step + 1);
      }
    } else if(step == 3) {
      const isAllinput = validateAllinput(register.gender, register.experience, register.size, register.interest,register.location);
      if(isAllinput){
        setStep(step+1);
      }
    }
  ...
  const handleSubmit = (e) => {
    ...
    if (terms) {
      ...
      console.log(register); // You can send the data to your server here
      ...
      <div className="register-page">
        <form className="register-form" onSubmit={handleSubmit}>
          ...
          {step === 1 && (
            <>
              ...
              <div className="register-form-group">
                ...
                {Errors && (
                  <div className="register-form-error">{Errors}</div>
                )}
            </>
          )}
            ...
            <>
              ...
              <div className="register-form-group">
                ...
                {confirmpasswordError && (
                  <div className="register-form-error">{confirmpasswordError}</div>
                )}
              </div>
            </>
          )}
          ...
          {step === 3 && (
            <>
              <div className="register-form-group">
              <center><h2>Garden Details</h2></center>
