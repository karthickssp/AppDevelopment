...
const Explore = () => {
  ...
  {selectedPlant && (
    <div className="plant-details">
      ...
      <div>
        <strong>Harvesting Age:</strong> {selectedPlant.harvestingAge}
      </div>
      <div>
        <strong>Season Condition:</strong> {selectedPlant.plantingSeason}
      </div>
      <div>
        <strong>Growing Condition:</strong> {selectedPlant.growingConditions}
      </div>
      <div>
        <strong>Water Consumption:</strong> {selectedPlant.wateringNeeds}
      </div>
      <div>
