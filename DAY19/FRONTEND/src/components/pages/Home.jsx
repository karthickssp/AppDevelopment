      ...
      <Fragment>
        <div className="centerContainer">
          <div className="description">
            <img
              className="des-img"
              src="https://images.pexels.com/photos/1145257/pexels-photo-1145257.jpeg?auto=compress&cs=tinysrgb&w=600"
              alt="Welcome description"
            />
            <div className="description_content">
              <div className="title">Welcome to PerfectGarden!</div>
              <p>
                We are your go-to source for all your home and garden needs.
                Explore our extensive collection of high-quality products and
                accessories designed to enhance your living spaces and bring
                beauty to your outdoor areas.
              </p>
              <Link to="/explore"><button className="explore">
                Explore
              </button></Link>
            </div>
          </div>
